...
function handleUpdateTask($db, $userId, $data, $type, &$debug_messages) {
    ...
    switch ($type) {
        ...
        case 'schedule': 
            ...
            break;
        case 'unschedule':
            // The 'updated_at = ?' clause is already part of the initial $setClauses and $params.
            // These clauses do not use placeholders, so no parameters should be added for them.
            $setClauses[] = "is_scheduled = 0";
            $setClauses[] = "start_time = NULL";
            $setClauses[] = "duration = NULL";
            break;
        default:
